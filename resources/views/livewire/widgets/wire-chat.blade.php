<div class="h-full ">
    ...
    x-data="{
     ...
     class ='w-full h-full bg-[var(--fc-light-primary)] dark:bg-[var(--fc-dark-primary)] border border-[var(--fc-light-secondary)] dark:border-[var(--fc-dark-secondary)] flex overflow-hidden rounded-lg'>
      <div :class="chatIsOpen && 'hidden md:grid'" class="relative  w-full h-full sm:border-r border-[var(--fc-light-border)] dark:border-[var(--fc-dark-border)]    md:w-[360px] lg:w-[400px] xl:w-[450px] shrink-0 overflow-y-auto  ">
          <livewire:fluxchat.chats :widget="true" />
      </div>
      <main
           x-data="ChatWidget()" 
           ...
           style="contain:content;">
            ...
            <div  x-show="!show && !chatIsOpen " class="m-auto  justify-center flex gap-3 flex-col  items-center ">
                ...
                <h4 class="font-medium p-2 px-3 rounded-full font-semibold bg-[var(--fc-light-secondary)] dark:bg-[var(--fc-dark-secondary)] dark:text-white dark:font-normal">@lang('fluxchat::widgets.fluxchat.messages.welcome')</h4>
