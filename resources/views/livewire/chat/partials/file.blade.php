...
<div class="flex items-center group overflow-hidden border border-[var(--fc-light-secondary)] dark:border-[var(--fc-dark-secondary)] rounded-xl">
    <span class=" p-2">
    ...
    <button class="px-3 bg-gray-50 bg-[var(--fc-light-secondary)] dark:bg-[var(--fc-dark-secondary)] transition-colors ease-in-out dark:hover:text-blue-500  hover:text-blue-500  dark:text-white  p-1 mt-auto   h-full">
