...
<img @class([ 
        ...
        'max-w-max  h-[200px] min-h-[210px] bg-[var(--fc-light-secondary)] dark:bg-[var(--fc-dark-secondary)]   object-scale-down  grow-0 shrink  overflow-hidden  rounded-3xl',
        ...
        loading="lazy" src="{{$attachment?->url}}" alt="{{  __('fluxchat::chat.labels.attachment') }}">
