...
<footer class="shrink-0 h-auto relative   sticky bottom-0 mt-auto">
    ...
    @if ($conversation->isGroup() && !$conversation->group?->allowsMembersToSendMessages() && !$authParticipant->isAdmin())
        <div
            class="dark:bg-[var(--fc-dark-secondary)]  bg-[var(--fc-light-secondary)] w-full text-center text-gray-600 dark:text-gray-200 justify-center text-sm flex py-4 ">
            Only admins can send messages
        </div>
    @else
        <div id="chat-footer" x-data="{ 'openEmojiPicker': false }"
            class=" px-3 md:px-1 border-t shadow-sm bg-[var(--fc-light-secondary)]  dark:bg-[var(--fc-dark-secondary)]   z-50   border-[var(--fc-light-primary)] dark:border-[var(--fc-dark-primary)] flex flex-col gap-3 items-center  w-full   mx-auto">
            ...
            <section wire:ignore x-cloak x-show="openEmojiPicker" x-transition:enter="transition  ease-out duration-180 transform"
                ...
                class="w-full flex hidden sm:flex   py-2 sm:px-4 py-1.5 border-b border-[var(--fc-light-primary)] dark:border-[var(--fc-dark-primary)]  h-96 min-w-full">
            ...
            <section
                class=" py-2 sm:px-4 py-1.5    z-50  dark:bg-[var(--fc-dark-secondary)]  bg-[var(--fc-light-secondary)]   flex flex-col gap-3 items-center  w-full mx-auto">
                        ...
                        <div x-data="attachments('media')">
                            ...
                            <section
                                ...
                                @foreach ($media as $key => $mediaItem)
                                    ...
                                    @if (str()->startsWith($mediaItem->getMimeType(), 'video/'))
                                        <div class="relative h-24 sm:h-36 ">
                                            ...
                                            <x-fluxchat::video height="h-24 sm:h-36 " :cover="false"
                                ...
                                <label wire:loading.class="cursor-progress"
                                    class="shrink-0 cursor-pointer relative w-16 h-14 rounded-lg  bg-[var(--fc-light-secondary)] dark:bg-[var(--fc-dark-primary)]   hover:bg-[var(--fc-light-primary)] dark:hover:bg-[var(--fc-dark-primary)] border border-[var(--fc-light-secondary)] dark:border-[var(--fc-dark-secondary)]  flex text-center justify-center ">
                        ...
                        <section x-data="attachments('files')"
                            ...
                            @foreach ($files as $key => $file)
                                <div class="relative shrink-0">
                                    ...
                                    {{-- File details --}}
                                    <div
                                        class="flex items-center group overflow-hidden bg-[var(--fc-light-primary)] dark:bg-[var(--fc-dark-primary)]   hover:border-[var(--fc-light-primary)] dark:hover:border-[var(--fc-dark-primary)] border border-[var(--fc-light-secondary)] dark:border-[var(--fc-dark-secondary)] rounded-xl">
                                        <span class=" p-2">
                                            {{-- document svg:HI --}}
                            ...
                            <label wire:loading.class="cursor-progress"
                                class="cursor-pointer shrink-0 relative w-16 h-14 rounded-lg bg-[var(--fc-light-primary)] dark:bg-[var(--fc-dark-primary)]   hover:border-[var(--fc-light-primary)] dark:hover:border-[var(--fc-dark-primary)] border border-[var(--fc-light-secondary)] dark:border-[var(--fc-dark-secondary)]  transition-colors   flex text-center justify-center  ">
                                <input wire:loading.attr="disabled"
                ...
                @if ($replyMessage != null)
                    <section class="p-px py-1 w-full col-span-12">
                        <div class="flex justify-between items-center dark:text-white">
                            <h6 class="text-sm">
                                    {{ $replyMessage?->ownedBy($this->auth) ? __('fluxchat::chat.labels.replying_to_yourself'): __('fluxchat::chat.labels.replying_to',['participant'=>$replyMessage->sendable?->name])  }}
                            </h6>
                ...
                document.querySelector('emoji-picker')
                    ...
                    <div class="w-10 hidden sm:flex max-w-fit  items-center">
                        <button wire:loading.attr="disabled" type="button" dusk="emoji-trigger-button"
                            ...
                            <svg x-bind:style="openEmojiPicker && { color: 'var(--fc-brand-primary)' }"
                    ...
                    @if (count($this->media) == 0 &&
                            count($this->files) == 0 &&
                            (config('fluxchat.allow_file_attachments', true) || config('fluxchat.allow_media_attachments', true)))
                        <x-fluxchat::popover position="top" popoverOffset="70">
                            ...
                            <div class="grid gap-2 w-full ">
                                ...
                                {{-- Upload Files --}}
                                @if (config('fluxchat.allow_file_attachments', true))
                                    <label wire:loading.class="cursor-progress" x-data="attachments('files')"
                                        ...
                                        <div
                                            class="w-full  flex items-center gap-3 px-1.5 py-2 rounded-md hover:bg-[var(--fc-light-primary)] dark:hover:bg-[var(--fc-dark-primary)] cursor-pointer">

                                            <span>
                                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                                    fill="currentColor" style="color: var(--fc-brand-primary);"
                                            ...
                                            <span class=" dark:text-white">
                                               @lang('fluxchat::chat.actions.upload_file.label')
                                            </span>
                                        </div>
                                    </label>
                                @endif
                                ...
                                {{-- Upload Media --}}
                                @if (config('fluxchat.allow_media_attachments', true))
                                        ...
                                        <div
                                            ...
                                            <span class="">
                                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                                                    ...
                                                    style="color: var(--fc-brand-primary);">
                                                    <path fill-rule="evenodd"
                                                        d="M1.5 6a2.25 2.25 0 0 1 2.25-2.25h16.5A2.25 2.25 0 0 1 22.5 6v12a2.25 2.25 0 0 1-2.25 2.25H3.75A2.25 2.25 0 0 1 1.5 18V6ZM3 16.06V18c0 .414.336.75.75.75h16.5A.75.75 0 0 0 21 18v-1.94l-2.69-2.689a1.5 1.5 0 0 0-2.12 0l-.88.879.97.97a.75.75 0 1 1-1.06 1.06l-5.16-5.159a1.5 1.5 0 0 0-2.12 0L3 16.061Zm10.125-7.81a1.125 1.125 0 1 1 2.25 0 1.125 1.125 0 0 1-2.25 0Z"
                                                        clip-rule="evenodd" />
                                                </svg>
                                            ...
                                            <span class=" dark:text-white">
                                               @lang('fluxchat::chat.actions.upload_media.label')
                                            </span>
                                        </div>
                                    </label>
                                @endif
                    ...
                    <div @class(['flex gap-2 sm:px-2 w-full'])>
                        <textarea @focus-input-field.window="$el.focus()" autocomplete="off" x-model='body' x-ref="body"
                            ...
                            type="text" name="message" placeholder="{{ __('fluxchat::chat.inputs.message.placeholder') }}" maxlength="1700" rows="1"
                    ...
                    <div x-cloak @class(['w-[5%] justify-end min-w-max  items-center gap-2 '])>
                        ...
                        <button
                            ...
                            id="sendMessageButton" class="cursor-pointer hover:text-[var(--fc-brand-primary)] transition-color ml-auto disabled:cursor-progress cursor-pointer font-bold">
            ...
            @script
                <script>
                    Alpine.data('attachments', (type = "media") => ({
                        ...
                        MAXFILES: @json(config('fluxchat.attachments.max_uploads', 5)), // Maximum number of files allowed
                        maxSize: @json(config('fluxchat.attachments.media_max_upload_size', 12288)) * 1024, // Max size per file (in bytes)
                        allowedFileTypes: type === 'media' ? @json(config('fluxchat.attachments.media_mimes')) :
                        @json(config('fluxchat.attachments.file_mimes')), // Allowed MIME types based on type
                            ...
                            files.forEach((file, index) => {
                                $wire.upload(
                                    ...
                                    (error) => {
                                        ...
                                        $dispatch('fluxchat-toast', { type: 'error', message: `Validation error: ${error}` });
                                    },
                                    (event) => {
                        ...
                        validateFiles(files, count) {
                            ...
                            if (totalFiles > this.MAXFILES) {
                                ...
                                $dispatch('fluxchat-toast', {
                                    type: 'warning',
                                    message: @js(__('fluxchat::validation.max.array', ['attribute' => __('fluxchat::chat.inputs.media.label'),'max'=>config('fluxchat.attachments.max_uploads', 5)]))
                                });
                            }
                            ...
                            if (invalidFiles.length > 0) {
                                invalidFiles.forEach((file) => {
                                    if (file.size > this.maxSize) {
                                        $dispatch('fluxchat-toast', {
                                            type: 'warning',
                                            message: @js(__('fluxchat::validation.max.file', ['attribute' => __('fluxchat::chat.inputs.media.label'),'max'=>config('fluxchat.attachments.media_max_upload_size', 12288)]))
                                        ...
                                        $dispatch('fluxchat-toast', {
                                            type: 'warning',
                                            message: @js(__('fluxchat::validation.mimes', [ 'attribute' => __('fluxchat::chat.inputs.media.label'), 'values' => implode(', ', config('fluxchat.attachments.media_mimes')) ]))
