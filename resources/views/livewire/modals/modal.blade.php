<div>
        ...
        window.FluxChatModal = () => {
            return {
                ...
                closeModalOnEscape(trigger) {
                   ...
                   if (trigger.modalType != 'FluxChatModal'){ return;}
                ...
                closeModal(force = false, skipPreviousModals = 0, destroySkipped = false) {
                    ...
                    if (this.destroyOnClose === true) {
                        Livewire.dispatch('destroyFluxChatModal', {
                            id: this.activeModalComponent
                        });
                    }
                ...
                init() {
                    ...
                    this.listeners.push(
                        Livewire.on('closeFluxChatModal', (data) => {
                    ...
                    this.listeners.push(
                        Livewire.on('activeFluxChatModalComponentChanged', ({
                            id
                        }) => {
    ...
    <div x-data="FluxChatModal()" x-on:close.stop="setShowPropertyTo(false)"
           x-on:keydown.escape.stop="closeModalOnEscape({modalType: 'FluxChatModal', event: $event })"
            tabindex="0"
        ...
        <div class="flex items-end  justify-center min-h-screen px-4 pt-4 pb-10 text-center sm:block sm:p-0">
            <div x-show="show" x-on:click="closeModalOnClickAway()" x-transition:enter="ease-out duration-300"
                ...
                <div class="absolute inset-0 bg-[var(--fc-light-primary)] dark:bg-[var(--fc-dark-primary)] opacity-75"></div>
            </div>
