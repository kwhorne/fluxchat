...
<div x-ref="popover"
    ...
    x-ref="popoverInner" x-show="popoverOpen" class="w-full p-2 bg-[var(--fc-light-primary)] dark:bg-[var(--fc-dark-secondary)]  border border-[var(--fc-light-secondary)]  dark:border-[var(--fc-dark-primary)] rounded-lg shadow-sm ">
