...
describe('Presence check', function () {
    ...
    it('has "chats title set in chatlist" as defualt', function () {
        ...
        Livewire::actingAs($auth)->test(Chatlist::class)
            ...
            ->assertSet('title', __('fluxchat::chats.labels.heading'))
            ->assertSee(__('fluxchat::chats.labels.heading'));
    });
    ...
    test('chat title can be set manually', function () {
        ...
        Livewire::actingAs($auth)->test(Chatlist::class, ['title' => 'Messages'])
            ->assertSee('Messages')
            ->assertSeeHtml('dusk="title"')
            ->assertDontSee(__('fluxchat::chats.labels.heading'));
    });
    ...
    it('doesnt shows search field if search is disabled in fluxchat.config:tesiting Search placeholder', function () {

        Config::set('fluxchat.allow_chats_search', false);
    ...
    it('doesnt shows search field if search MANUALLY disabled at widget level even if in fluxchat.config.allow_chats_search is true', function () {

        Config::set('fluxchat.allow_chats_search', true);
    ...
    it('shows search field if search is enabled in fluxchat.config.allow_chats_search Search placeholder', function () {
    ...
    it('shows search field even if search is DISABLED in fluxchat.config.allow_chats_search but ENABLED at component level', function () {
    ...
    test('it_shows_new_chat_modal_button_if_enabled_in_config', function () {
        ...
        Config::set('fluxchat.show_new_chat_modal_button', true);
        $auth = User::factory()->create();
    ...
    test('it_does_not_show_new_chat_modal_button_if_not_enabled_in_config', function () {
        ...
        Config::set('fluxchat.show_new_chat_modal_button', false);
        $auth = User::factory()->create();
...
describe('List', function () {
    ...
    it('shows message time AS "now"  if less than a minute old', function () {
        ...
        Livewire::actingAs($auth)->test(Chatlist::class)
            ->assertSeeText(__('fluxchat::chats.labels.now'));
    });
