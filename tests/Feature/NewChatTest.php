...
//     Config::set('fluxchat.show_new_group_modal_button',false);
//     $auth = ModelsUser::factory()->create();
...
it('shows New group if allowed', function () {
    ...
    Config::set('fluxchat.show_new_group_modal_button', true);
    $auth = ModelsUser::factory()->create();
...
describe('Creating conversation', function () {
    ...
    test('it dispataches Livewire events "closeFluxChatModal" after creating conversation', function () {
    ...
    test('it redirects and does not dispatach Livewire events "open-chat" events after creating conversation if is not Widget', function () {
        ...
        // assert redirect
        $request
            ->assertRedirect(route(FluxChat::viewRouteName(), $conversation->id))
    ...
    test('it does not redirects but  dispataches Livewire events "open-chat" events after creating conversation if IS Widget', function () {
        ...
        // assert redirect
        $request
            ->assertNoRedirect(route(FluxChat::viewRouteName(), $conversation->id))
