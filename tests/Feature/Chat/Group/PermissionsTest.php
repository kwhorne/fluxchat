...
describe('Presence check', function () {
    ...
    test('"Edit Group Information" label ,desciption is set and property wired', function () {
        ...
        Livewire::actingAs($auth)->test(Permissions::class, ['conversation' => $conversation])
            ->assertSee(__('fluxchat::chat.group.permisssions.actions.edit_group_information.label'))
            ->assertSee(__('fluxchat::chat.group.permisssions.actions.edit_group_information.helper_text'))
    ...
    test('"Send messages "label is set and property wired', function () {
        ...
        Livewire::actingAs($auth)->test(Permissions::class, ['conversation' => $conversation])
            ->assertSee(__('fluxchat::chat.group.permisssions.actions.send_messages.label'))
    ...
    test('"Add other members" label is set and property wired', function () {
        ...
        Livewire::actingAs($auth)->test(Permissions::class, ['conversation' => $conversation])
            ->assertSee(__('fluxchat::chat.group.permisssions.actions.add_other_members.label'))
