...
namespace Kwhorne\FluxChat\Tests;
...
abstract class TestCase extends \Orchestra\Testbench\TestCase
{
    ...
    protected function defineEnvironment($app)
    {
        ...
        tap($app['config'], function (Repository $config) {
            ...
            // set up user model
            $config->set('fluxchat.user_model', \Workbench\App\Models\User::class);
    ...
    {
        parent::setUp();
        // Config::set(\Kwhorne\FluxChat\Workbench\App\Models\User::class, \App\Models\User::class);
