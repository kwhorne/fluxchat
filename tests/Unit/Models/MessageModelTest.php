...
it('returns correct attachment ', function () {
    ...
    // save photo to disk
    $path = $attachment->store(config('fluxchat.attachments.storage_folder', 'attachments'), config('fluxchat.attachments.storage_disk', 'public'));
...
describe('DeleteFor Everyone', function () {
    ...
    it('deletes attachment from storage when message is deleted', function () {
        ...
        Storage::disk(config('fluxchat.attachments.storage_disk', 'public'))->assertExists($attachment->file_path);
        ...
        // assert
        Storage::disk(config('fluxchat.attachments.storage_disk', 'public'))->assertMissing($attachment->file_path);
    });
