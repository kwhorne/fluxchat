...
it('tests attachment URL generation with custom test_disk', function () {
    ...
    $this->app['config']->set('fluxchat.attachments.storage_disk', 'test_disk');
...
it('generaes temporary URL when disk_visibility is private in fluxchat', function () {

    // Set the test disk as default for this
    FacadesConfig::set('fluxchat.attachments.storage_disk', 's3');
    FacadesConfig::set('fluxchat.attachments.disk_visibility', 'private');
...
it('does not generate temporary URL when disk_visibility is public in fluxchat', function () {

    // Set the test disk as default for this    test
    FacadesConfig::set('fluxchat.attachments.storage_disk', 'public');
    FacadesConfig::set('fluxchat.attachments.disk_visibility', 'public');
