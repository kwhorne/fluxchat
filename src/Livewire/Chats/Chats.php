...
namespace Kwhorne\FluxChat\Livewire\Chats;
...
class Chats extends Component
{
    ...
    public function getListeners()
    {
        ...
        return [
            ...
            "echo-private:participant.{$encodedType}.{$userId},.Kwhorne\\FluxChat\\Events\\NotifyParticipant" => 'refreshComponent',
        ];
    }
    ...
    {
        $searchableFields = FluxChat::searchableFields();
    ...
    public function mount(
        ...
        // If a value is passed, use it; otherwise fallback to FluxChat defaults.
        $this->showNewChatModalButton = isset($showNewChatModalButton) ? $showNewChatModalButton : FluxChat::showNewChatModalButton();
        $this->allowChatsSearch = isset($allowChatsSearch) ? $allowChatsSearch : FluxChat::allowChatsSearch();
        $this->showHomeRouteButton = isset($showHomeRouteButton) ? $showHomeRouteButton : ! $this->widget;
        $this->title = isset($title) ? $title : __('fluxchat::chats.labels.heading');
    ...
    public function render()
    {
        ...
        return view('fluxchat::livewire.chats.chats');
    }
}
