...
namespace Kwhorne\FluxChat\Livewire\Concerns;
...
abstract class ModalComponent extends Component
{
    ...
    public function closeFluxChatModal(): void
    {
        $this->dispatch('closeFluxChatModal', force: $this->forceClose, skipPreviousModals: $this->skipModals, destroySkipped: $this->destroySkipped);
    }
