...
namespace Kwhorne\FluxChat\Livewire\Modals;
...
class Modal extends Component
{
    ...
    public function openFluxChatModal($component, $arguments = [], $modalAttributes = []): void
    {
        ...
        $this->dispatch('activeFluxChatModalComponentChanged', id: $id);
    }
    ...
    public function destroyFluxChatModal($id): void
    {
    ...
    {
        return view('fluxchat::livewire.modals.modal');
    }
}
