...
namespace Kwhorne\FluxChat\Livewire\Widgets;
...
class FluxChat extends Component
{
    public ?string $activeFluxChatWidgetComponent = null;
    ...
    public function resetState(): void
    {
        ...
        $this->activeFluxChatWidgetComponent = null;
    ...
    public function openChatWidget($conversation, $arguments = [], $modalAttributes = []): void
    {
        ...
        $this->activeFluxChatWidgetComponent = $id;
    ...
    {
        return view('fluxchat::livewire.widgets.wire-chat');
    }
}
