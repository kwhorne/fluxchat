...
use Kwhorne\FluxChat\Models\Scopes\WithoutRemovedActionScope;
...
class Participant extends Model
{
    ...
    {
        $this->table = FluxChat::formatTableName('participants');
     ...
     *
     * @return \Kwhorne\FluxChat\Workbench\Database\Factories\ParticipantFactory
     */
    protected static function newFactory()
    {
        return \Kwhorne\FluxChat\Workbench\Database\Factories\ParticipantFactory::new();
    }
     ...
     *
     * @param  Builder<\Kwhorne\FluxChat\Models\Participant>  $query
     */
