...
namespace Kwhorne\FluxChat\Models\Concerns;
...
trait HasDynamicIds
{
    ...
    {
        $this->usesUniqueIds = FluxChat::usesUuid();
    }
    ...
    {
        return FluxChat::usesUuid() ? 'string' : 'int';
    }
