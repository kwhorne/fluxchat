...
use Kwhorne\FluxChat\Models\Concerns\HasDynamicIds;
 ...
 * @property-read \Kwhorne\FluxChat\Models\Group|null $group
 * @property-read \Kwhorne\FluxChat\Models\Message|null $lastMessage
 * @property-read \Illuminate\Database\Eloquent\Collection<int, \Kwhorne\FluxChat\Models\Message> $messages
 * @property-read int|null $messages_count
 * @property-read \Illuminate\Database\Eloquent\Collection<int, \Kwhorne\FluxChat\Models\Participant> $participants
...
class Conversation extends Model
{
    ...
    {
        $this->table = FluxChat::formatTableName('conversations');
    ...
    {
        return \Kwhorne\FluxChat\Workbench\Database\Factories\ConversationFactory::new();
    }
     ...
     * @return \Illuminate\Database\Eloquent\Collection<int,\Kwhorne\FluxChat\Models\Message>
     */
    public function unreadMessages(Model|Authenticatable $user): \Illuminate\Database\Eloquent\Collection
    {
        ...
        // WORKING
        /** @var \Illuminate\Database\Eloquent\Collection<int, \Kwhorne\FluxChat\Models\Message> $messages */
