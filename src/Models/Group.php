...
use Kwhorne\FluxChat\Enums\GroupType;
 ...
 * @property-read \Kwhorne\FluxChat\Models\Conversation $conversation
 * @property-read \Kwhorne\FluxChat\Models\Attachment|null $cover
...
class Group extends Model
{
    ...
    {
        $this->table = FluxChat::formatTableName('groups');
    ...
    protected static function boot()
    {
        ...
        static::deleted(function ($group) {
            ...
            if ($group->cover?->exists()) {
                ...
                if (Storage::disk(FluxChat::storageDisk())->exists($group->cover->file_path)) {
                    Storage::disk(FluxChat::storageDisk())->delete($group->cover->file_path);
                }
            }
    ...
    {
        return \Kwhorne\FluxChat\Workbench\Database\Factories\GroupFactory::new();
    }
