...
class Attachment extends Model
{
    ...
    {
        $this->table = FluxChat::formatTableName('attachments');
    ...
    {
        return \Kwhorne\FluxChat\Workbench\Database\Factories\AttachmentFactory::new();
    }
    ...
    protected function generateUrl(?string $path): ?string
    {
        ...
        $disk = Storage::disk(FluxChat::storageDisk());

        $config = config('fluxchat.attachments');
